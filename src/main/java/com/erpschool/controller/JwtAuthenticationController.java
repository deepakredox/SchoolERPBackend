...
import com.erpschool.model.AuthenticationJwtResponse;
...
public class JwtAuthenticationController {
	...
	public ResponseEntity<?> createAuthenticationToken(@RequestBody UserDtls authenticationRequest) throws Exception {
